...
M_REFLECTIONS=4       # Layer 2: số nhánh self-reflection per rollout
BATCH_SIZE_K=16       # Kích thước batch tĩnh (50/50)
...
# Chạy training với tee để vừa hiển thị vừa ghi log
cd "$PIPELINE_DIR"
run_cmd "${FULL_CMD[@]}" 2>&1 | tee "$LOG_FILE"
